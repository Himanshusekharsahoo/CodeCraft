...
export async function POST(request) {
  try {
    ...
    const systemInstruction = `You are an expert technical writer and code documenter. Generate clear, concise documentation comments formatted using the standard comment convention for ${targetLanguage} (e.g., JSDoc for JavaScript/TypeScript, docstrings for Python, Javadoc for Java, /* */ for C/C++). Return ONLY the comments to be placed at the end or top of the file. Do NOT include markdown code fences, do not repeat the original code, and do not add introductory remarks.`;
    const prompt = `Generate documentation for the following ${targetLanguage} code:\n\n${guardedCode}`;
